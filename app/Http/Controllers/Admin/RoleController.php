...
class RoleController extends Controller
{
    ...
    public function __construct(Role $role, RolesTransformer $rolesTransformer,
        PermissionsTransformer $permissionsTransformer)
    {
        $this->role             = $role;
    ...
    public function store(Request $request)
    {
        ...
        flash(trans('messages.role-add'),'success');
        return back();
    }
